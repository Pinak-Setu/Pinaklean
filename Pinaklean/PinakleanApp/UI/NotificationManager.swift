// NotificationManager.swift - Notification system for Pinaklean
import Foundation
...
public class NotificationManager: NSObject, ObservableObject {
    ...
    @Published public var pendingNotifications: [PinakleanNotification] = []
...
public struct PinakleanNotification: Identifiable, Codable {
    public let id = UUID()
